...
const imgDiv = document.getElementsByClassName("wrap")[0];
const buttonGroup = document.getElementsByClassName("buttons")[0].children;
const tdGroup = document.getElementById("bd").getElementsByTagName("table")[0].getElementsByTagName("td");
const width = 600;  //图片宽度
const interval = 5;  //动画间隔
const transitionPerPage = width * interval / 1000;  //对应翻一页时每次动画移动长度
let currentPage = 1;
let canManualPlay = true;
...
function setPage(pageNumber) {
    ...
    let animation = setInterval(function () {
        if (transition === pageToChange * width) {
            ...
            left = width * previousPage + transition;
